    ...
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                ...
                {[[120, 180], [360, 140], [700, 180], [80, 320], [500, 280], [200, 100], [500, 60], [900, 100]].map(([cx, cy], i) => (
                    <motion.circle
                        key={i}
                        cx={cx}
                        cy={cy}
...
function PCBVisual() {
    return (
        <div className="relative w-full max-w-md mx-auto select-none">
            <motion.div className="animate-float-slow relative" style={{ perspective: 1000 }}>
            ...
            <motion.div className="absolute -top-4 -right-4 bg-white rounded-xl shadow-xl px-3 py-2 flex items-center gap-2 text-sm font-semibold text-secondary" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 1.2 }}>
                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                Custom Design and Layout
            </motion.div>
            <motion.div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-xl px-3 py-2 text-sm font-semibold text-secondary flex items-center gap-2" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 1.5 }}>
                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                Quality Testing
            </motion.div>
        </div>
...
export default function HomePageClient() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
                ...
                <div className="section-container w-full relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div initial="hidden" animate="visible" variants={stagger}>
                            ...
                            <motion.h1 variants={fadeUp} className="text-3xl sm:text-4xl md:text-5xl font-display font-bold leading-[1.15] text-white mb-6">
                                India's Biggest PCB Manufacturer in Ahmedabad <span className="text-gradient">Megabytes Circuit Systems</span>
                            </motion.h1>
            ...
            {/* 1.3 DETAILED OVERVIEW SECTIONS */}
                ...
                <div className="section-container">
                    ...
                    <InViewSection>
                        <motion.div variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { icon: Wrench, title: "Prototype PCB", desc: "Quick-turn prototype PCB fabrication to test and validate your designs fast.", link: "/prototype-pcb", color: "from-green-50 to-emerald-50" },
                                { icon: Settings, title: "PCB Design", desc: "Professional schematic design and high-speed multi-layer PCB layout services.", link: "/pcb-design-ahmedabad", color: "from-blue-50 to-sky-50" },
                                { icon: CircuitBoard, title: "PCB Manufacturing", desc: "High-quality single layer, double layer, and complex multilayer PCB production.", link: "/pcb-manufacturing-ahmedabad", color: "from-emerald-50 to-teal-50" },
                                { icon: Cpu, title: "PCB Assembly", desc: "Advanced SMT, through-hole, mechanical, and complete turnkey assembly services.", link: "/pcb-assembly-ahmedabad", color: "from-sky-50 to-indigo-50" },
                                { icon: Activity, title: "PCB Developing Services", desc: "Comprehensive board development, firmware integration, and hardware engineering solutions.", link: "/pcb-developing-services-ahmedabad", color: "from-purple-50 to-violet-50" },
                                { icon: Hammer, title: "PCB Fabrication", desc: "Precision copper routing, micro-drilling, custom profiling, and panelization.", link: "/pcb-fabrication-ahmedabad", color: "from-amber-50 to-orange-50" },
                                { icon: FileCheck, title: "Design For Manufacturability (DFM) Support", desc: "Thorough DFM analysis and engineering reviews to prevent production errors.", link: "/design-for-manufacturability-dfm-support", color: "from-rose-50 to-red-50" },
                                { icon: Shield, title: "Testing And Quality Assurance", desc: "100% AOI, flying probe testing, electrical checks, and visual inspections.", link: "/testing-and-quality-assurance", color: "from-teal-50 to-cyan-50" },
                            ].map((service, i) => (
                    ...
                    <InViewSection>
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                <motion.div key={i} variants={fadeUp} className="group relative bg-white rounded-2xl border border-slate-100 p-6 flex flex-col justify-between h-full transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_20px_50px_rgba(17,122,51,0.08)] hover:border-primary/25 cursor-pointer overflow-hidden">
                                    <div className="absolute -right-6 -top-6 w-20 h-20 rounded-full bg-primary/5 blur-xl group-hover:bg-primary/10 transition-all duration-300 pointer-events-none" />
                                    <div>
