                    ...
                    >
                      ...
                      <div className="border-t border-primary/10 pt-3 space-y-1">
                        <div className="flex justify-between text-xs text-muted-foreground">
                          <span>Base cost</span>
                          <span>₹{calculateQuote.data.breakdown.baseCost.toLocaleString("en-IN")}</span>
                        </div>
                        <div className="flex justify-between text-xs text-muted-foreground">
                          <span>Layer surcharge</span>
                          <span>₹{calculateQuote.data.breakdown.layerSurcharge.toLocaleString("en-IN")}</span>
                        </div>
                        <div className="flex justify-between text-xs text-muted-foreground">
                          <span>Surface finish</span>
                          <span>₹{calculateQuote.data.breakdown.finishSurcharge.toLocaleString("en-IN")}</span>
                        </div>
                      </div>
