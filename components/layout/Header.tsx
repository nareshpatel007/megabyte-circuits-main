  ...
  return (
    <>
      ...
      >
        {/* ── Top bar ─────────────────────────────────────────── */}
        <div
          className={`hidden md:block w-full text-xs transition-colors ${
            isTransparent
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between gap-6">
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
              <div className="bg-primary p-1.5 rounded-lg text-white group-hover:bg-primary/85 transition-colors">
              ...
              >
                MegaByte's{" "}
                <span className="text-primary">Circuits</span>
              </span>
            </Link>
